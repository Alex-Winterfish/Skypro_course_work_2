...
def user_operation():
    ...
    Запрашивает у пользователя дальнейшие операции после запуска программы"""
...
def user_request():
    """Функция запрашивает у пользователя вакансию для выгрузки с НН.ру и число вакансий"""
...
def user_interaction():
    """Функция запрашивает у пользователя дальнейшие операции при работе с файлом с вакансиями"""
    user_input = input(
...
def user_file_interaction(user_input: str):
    """Функция запрашивает у пользователя желаемые операции при работе с файлом с вакансиями"""
    if user_input == "1":
